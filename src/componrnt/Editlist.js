...
function Editlist() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await axios.put(`https://6278f6666ac99a9106601019.mockapi.io/subcategory/${id}`, values);
    ...
    const fetch = async () => {
        try {
            let userData =
                ...
                await axios.get(`https://6278f6666ac99a9106601019.mockapi.io/subcategory/${id}`);
